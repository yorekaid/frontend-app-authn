...
const BaseContainer = ({
  children, showWelcomeBanner, fullName, fixedHeight,
}) => {
  const enableImageLayout = getConfig().ENABLE_IMAGE_LAYOUT;

  if (enableImageLayout) {
    return (
          <div className={classNames('layout', { 'layout--fixed': fixedHeight })}>
  ...
  return (
      <>
          <div className={classNames('col-md-12 extra-large-screen-top-stripe', { 'd-none': fixedHeight })} />
          <div className={classNames('layout', { 'layout--fixed': fixedHeight })}>
